...
var frameCount = 0;
var rows = 14;
var multipliers = ['170x', '15x', '6x', '2x', '1x', '0.7x', '0.5x', '0.2x', '0.5x', '0.7x', '1x', '2x', '6x', '15x', '170x'];
var multiVals = [170, 15, 6, 2, 1, 0.7, 0.5, 0.2, 0.5, 0.7, 1, 2, 6, 15, 170];
    ...
    p5.draw = () => {
        ...
        if (once) {
            ...
            for (var i = 0; i < numPlinkos; i++) {
                var horizOffset = Math.random() * 0.8 - 0.4;
